        ...
        <div class="main-panel">
            <div class="content">
                ...
                <div class="page-inner mt--5">
                    <!-- Button -->
                    <div class="d-flex">
                        <a class="btn btn-round btn-add ml-auto mb-3" href="{{ route('admin.payment_method.create') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="add-row" class="display table table-striped table-hover dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="add-row" width='20%'>
                                                    <center>No</center>
                                                </th>
                                        ...
                                        @foreach($payment_methods as $key=>$payment_method)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="sorting_1">
                                                    <center>{{$payment_method->payment_method}}</center>
                                                </td>
                                                <td>
                                                    <center>
                                                        <div class="form-button-action">
                                                            <a href="{{route('admin.payment_method.detail', $payment_method->id) }}" data-toggle="tooltip" title="Detail"
                                                                class="btn btn-link btn-icon btn-lg"
                                                                data-original-title="Detail" control-id="ControlID-16">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                            <a href="{{route('admin.payment_method.edit', $payment_method->id) }}" data-toggle="tooltip" title="Edit"
                                                            ...
                                                            <button type="submit" onclick="destroy({{$payment_method->id}})" data-toggle="tooltip" title="Delete"
...
<script>
    ...
    swal({
          ...
          if (willDelete) {
            $.post("{{route('admin.payment_method.delete')}}",{ id:id,_token:token},function(data){
                location.reload();
            })
          } else {
            return false;
